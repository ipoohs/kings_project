...
findAssocs(true_dtm, 'state', 0.2)
findAssocs(true_dtm, 'presid', 0.2)
findAssocs(true_dtm, 'reuter', 0.2)
findAssocs(true_dtm, 'much', 0.2)
```


Turning the datasets to Document Term Matrix
